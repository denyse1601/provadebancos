...
/*ex 1*/
INSERT INTO Livros (titulo,autor,disponivel,categoria,isbn,editora,quantidade_paginas,idioma);
values ('As Crônicas de Nárnia', 'C.S Lewis','1950','disponível','Fantasia','978-0-06447-119-0','Harper Collins','768','Francês');
/*ex2*/
UPDATE Livros disponivel FALSE '1980';
/*ex3*/
update editora to 'Plume Books';
/*ex4*/
delete from ano_publicacao;
/*ex5*/
select* where quantidade_paginas limit 650;
/*ex6*/
SELECT categoria
FROM livros
WHERE categoria
GROUP BY categoria count (livros);
/*ex7*/
